...
- Verified source commit: `RECORDED_AFTER_FINAL_GATES`.
- Initial machine-evidence artifact commit: `RECORDED_AFTER_INITIAL_EVIDENCE_COMMIT`.
- Machine evidence SHA-256: `RECORDED_AFTER_EVIDENCE_BINDING`.
