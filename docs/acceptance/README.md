...
本目录把“产品负责人能理解和复核的说明”与“不可变技术证据”放在同一个入口。当前所有
`VERIFIED` 都限定为本地合成工程；尚无 `ACCEPTED` 或 `RELEASED` 项。

## 总览

- [产品负责人进度总览](PRODUCT-OWNER-PROGRESS.md)

## Owner Summary 与五分钟验证

- [EPIC-01：工程地基](EPIC-01-owner-summary.md)
- [EPIC-02：Scenario Package 契约与生命周期](EPIC-02-owner-summary.md)
- [EPIC-02.5：组织、工作空间、项目与权限](EPIC-02.5-owner-summary.md)
...
- [EPIC-01/02 Evidence](EPIC-01-02-evidence.md)
- [EPIC-02.5 Evidence](EPIC-02.5-evidence.md)
...
- [EPIC-01/02 machine evidence](generated-verification-evidence.json)
- [EPIC-02.5 machine evidence](generated-epic-02.5-evidence.json)
